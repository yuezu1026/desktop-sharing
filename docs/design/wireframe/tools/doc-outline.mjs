...
const WHEN_TO_READ = {
  ...
  "docs/plans/技术方案.md":
    "定语言和部署边界时读。控制面 TypeScript，数据面和电脑被控端 Rust，手机界面 React Native。不改已拍板范围。",
  "docs/plans/MVP.md":
    "排第一个可发布版本时。只含挡住发版的 P0；安卓被控不在这里。",
  "docs/plans/S1.md":
    "排手机被控、电脑控手机、远程音频时。不阻塞 MVP。",
  "docs/plans/S2.md":
    "排体验完善（原 P1）时：iOS 控制端、外接大屏、个人中心、插件。",
  "docs/plans/S3.md":
    "排眼镜桥接时。有硬件前提才开工。",
  "docs/plans/S4.md":
    "有人要把眼镜直连排进工期时读。本阶段不排期、不做工程承诺。",
