...
| 层 | 判据 | 处理 | 数量 |
|---|---|---|---|
| **① UI = 已拍板决策的执行体** 🔴 | 没有这个界面，**已拍板的决策/合规项就被违反**（例：禁止静默降码率 ⇒ 必须有「码率已降」明示） | **P0 必做**，且**不参与 ROI 排序** | 24 |
...
> 共 **42 个界面条目 ⇒ 45 张线框图**（多出的 3 张：W1-05「降级链」四态各出一张；**W2-07 为可点击原型跑出后补的帧**；🔴 **W1-10 / W2-08 为 `[新增·D19]` 的音频两帧**）。
