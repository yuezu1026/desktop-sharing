...
> 共 **59 个界面条目 ⇒ 65 张线框图**，层分布 **① 41 / ② 3 / ③ 15**，优先级 **P0 51 / P1 8**。
...
| 画布 | 标准尺寸：桌面 `830×500`、窗口 `760×440`、移动 `330×620`、面板 `430×470` / `430×300`。**单帧可因内容加高**（如 W5-06 `700`、W6-07 `560`、W6-02 `640`、W6-04 `474`、**W5-03 `530`**、**W1-08 `530`**、W4-05 `460`、W1-04 `346`、🔴 **W3-07 `560`**、W3-08 `480`、W3-10 `470`、W3-01 `464`、W3-06 `460`、**W5-07 `620`**、W5-08 `480`），以帧内 inline `height` 为准；改稿后由 `tools/wireframe-selfcheck.mjs` 校验无裁切 |
...
> ⇒ 该轮结束时为 **55 个界面条目 ⇒ 58 张线框图**（层分布 ① 37 / ② 3 / ③ 15，P0 47 / P1 8）。
...
> ⇒ 全项目 **59 个界面条目 ⇒ 65 张线框图**，层分布 **① 41 / ② 3 / ③ 15**，优先级 **P0 51 / P1 8**（见 §1 / §2）。
