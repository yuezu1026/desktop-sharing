...
> （W1-06 / W1-06b 是**两个独立条目**，各占一图；🔴 **W1-10 / W2-08 为 `[新增·D19]` 的音频两帧**，也是独立条目 9b / 15c；🔴 **W1-11 / W6-09 为 `[新增·D22]` 的全屏漫没两帧**，是独立条目 9c / 44；🔴 **W3-07 ~ W3-10 为 `[新增·D23]` 的账号自助管理四帧**，是独立条目 21b / 21c / 21d / 21e。）
...
**结论：五件事里三件有、两件完全没有。** 而且顺着这条线又抳出 **4 个同属账号类、此前零登记**的缺口。
