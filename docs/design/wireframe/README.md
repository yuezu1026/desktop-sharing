...
| 画布 | 标准尺寸：桌面 `830×500`、窗口 `760×440`、移动 `330×620`、面板 `430×470` / `430×300`。**单帧可因内容加高**（如 W5-06 `700`、W6-07 `560`、W6-02 `640`、W6-04 `474`、**W5-03 `530`**、W4-05 `460`、W1-04 `346`），以帧内 inline `height` 为准；改稿后由 `tools/wireframe-selfcheck.mjs` 校验无裁切 |
